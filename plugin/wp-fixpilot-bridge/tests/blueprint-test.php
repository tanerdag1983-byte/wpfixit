...
$draft = $controller->create_draft(200, [
    ...
    'slug' => 'dsg-revisie-specialist-schiedam',
    'replacements' => valid_replacements(),
    'seo' => [
        'title' => 'SEO titel',
        'description' => 'SEO omschrijving',
...
assert(get_post($draft['wordpress_object_id'])->post_title === 'DSG revisie specialist Schiedam');
assert(get_post($draft['wordpress_object_id'])->post_name === 'dsg-revisie-specialist-schiedam');
...
assert($health['plugin_version'] === '0.3.4');
